// versión completa del commit "add api rout handlers" 
...
//nuevas validaciones jueves 26 de mayo
...
function validatePositiveInteger(number, explain = 'number') {
    ...
    if (!Number.isInteger(number)) throw new FormatError (`is not an integer`)
...
// aquí acaba la transcripción del commit: "add api route handlers" 2022/05/26 1034